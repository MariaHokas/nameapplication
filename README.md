...
This Project is a Simple POST ReactJS Project created with create.react-app. State management is handled with useReducer Hook. The project demonstrates the following
